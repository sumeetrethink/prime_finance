...
@section('content')
    ...
    <section class="page-banner">
        <div class="image-layer lazy-image" data-bg="url('assets/images/background/image-20.jpg')"></div>
                ...
                <form action="{{ url('contact') }}" method="post">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="phone" id="email" placeholder="Enter phone number here......"
                                required="" />
